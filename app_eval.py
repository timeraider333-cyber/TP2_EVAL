...
if fichier is not None:
    ...
    if len(colonnes_numeriques) < 2:
        st.warning(" Le fichier doit contenir au moins 2 colonnes numériques pour la visualisation.")
    else:
...
Vous pouvez **faire tourner** le graphique en cliquant et glissant la souris.
    ...
    st.info(" Veuillez charger un fichier CSV pour commencer la visualisation.")
